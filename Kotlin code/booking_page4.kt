...
class booking_page4 : AppCompatActivity() {
    ...
    //private var selectedOption4: String? = null


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_booking_page4)
        ...
        val radioGroup2 = findViewById<RadioGroup>(R.id.radio_button_5)
        radioGroup2 .setOnCheckedChangeListener { group, checkedId ->
            val selectedRadioButton = findViewById<RadioButton>(checkedId)
            selectedOption5 = selectedRadioButton.text.toString()
            }

        val fifth_Button: Button = findViewById(R.id.next_button)
        fifth_Button.setOnClickListener {
            if (::selectedOption5.isInitialized) {
                val intent = Intent(this, booking_page5::class.java)
